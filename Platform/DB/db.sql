...
CREATE TABLE public.KnowledgeBase (
  ...
  file_type character varying NOT NULL CHECK (file_type::text = ANY (ARRAY['pdf'::character varying, 'url'::character varying]::text[])),
  description text,
  uploaded_by uuid,
  ...
  CONSTRAINT KnowledgeBase_uploaded_by_fkey FOREIGN KEY (uploaded_by) REFERENCES public.Users(id)
);
