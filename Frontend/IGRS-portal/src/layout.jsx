...
function Layout({ userRole, onLogout, userAuth }) {
  ...
  return (
    <div className="min-h-screen transition-colors duration-300 flex overflow-hidden relative bg-transparent">
      ...
      <div className="fixed inset-y-0 left-0 w-16 lg:w-64 bg-white border-r border-gray-200 flex flex-col h-screen transition-all duration-300 z-20">
        {/* Logo section */}
        ...
        <div className="border-t border-gray-200 p-2 lg:p-4 space-y-2">
          ...
          <div className="flex items-center justify-center lg:hidden gap-4">
            <button
              onClick={() => {
      ...
      {/* Main content */}
      <div className="flex-1 flex flex-col ml-16 lg:ml-64 h-screen overflow-hidden relative z-10">
        {/* Top Navbar - sticky */}
