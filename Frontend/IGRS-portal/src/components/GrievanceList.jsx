...
import { 
  ...
  ChevronDown, ChevronUp, X, Eye, Calendar
} from 'lucide-react';
      ...
      comments: [
        {
          id: 1,
          author: "John Doe",
          text: "Initial assessment completed. Water pressure is indeed low in the area.",
        ...
        },
        {
          id: 2,
          author: "Sarah Smith",
          text: "Field team has been dispatched. Expected to reach location by 2 PM.",
          timestamp: "2024-02-21 11:15 AM",
          avatar: "SS"
        }
      ]
    },
      ...
      comments: [
        {
          id: 1,
          author: "Mike Johnson",
          text: "Road inspection scheduled for tomorrow morning.",
          timestamp: "2024-02-19 2:30 PM",
          avatar: "MJ"
        }
      ]
    },
      ...
      comments: [
        {
          ...
          text: "New collection schedule has been implemented. Please check the updated timings.",
          timestamp: "2024-02-18 9:00 AM",
          avatar: "ST"
        }
      ]
    },
