...
-- Add foreign key constraint for contractor_report_id
-- This links contractors to their featured report
ALTER TABLE public.contractors 
ADD CONSTRAINT contractors_contractor_report_id_fkey 
FOREIGN KEY (contractor_report_id) 
REFERENCES public.contractor_reports(id) 
ON DELETE SET NULL;

-- Create index for better query performance
CREATE INDEX IF NOT EXISTS idx_contractors_contractor_report_id 
ON public.contractors(contractor_report_id);

-- Comment for documentation
COMMENT ON COLUMN public.contractors.contractor_report_id IS 'Reference to the featured/primary report to display on contractor card';
