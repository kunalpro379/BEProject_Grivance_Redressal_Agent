      ...
      <div className="relative z-10 w-full max-w-md px-4 py-6">
        <div className="bg-white rounded-2xl shadow-xl p-6 space-y-6">
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Officials Portal</h1>
            <p className="text-xs text-gray-600">Secure access for government officials and administrators</p>
          </div>
            ...
            {!isLogin && (
              <div className="mb-4">
                ...
                <div className="text-center">
                  <span className="text-xs font-semibold text-gray-900">{getStepLabel()}</span>
                </div>
              </div>
            )}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-all duration-200 text-sm"
