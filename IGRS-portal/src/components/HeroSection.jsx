...
const HeroSection = () => {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-20">
      ...
      <div className="absolute inset-0 z-0 bg-cream-gradient" />

      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        {/* Trust Badge */}
        <div 
          className={`inline-flex items-center space-x-2 bg-black text-white rounded-full px-5 py-2 text-xs font-bold mb-6 shadow-lg transition-all duration-700 ${
        ...
        {/* Main Heading */}
        <h1 
          className={`text-4xl md:text-5xl font-black text-black mb-5 leading-tight transition-all duration-700 ${
        ...
        >
          ...
          <br />
          <span className="bg-gradient-to-r from-gray-700 to-gray-900 bg-clip-text text-transparent">Redressal System</span>
        </h1>

        {/* Subtitle */}
        <p 
          className={`text-base md:text-lg text-gray-700 font-semibold mb-10 max-w-3xl mx-auto leading-relaxed transition-all duration-700 ${
        ...
        {/* Statistics Row */}
        <div 
          className={`flex flex-wrap justify-center gap-10 mb-10 transition-all duration-700 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
          }`}
          style={{ transitionDelay: '800ms' }}
        >
          <div className="text-center">
            <div className="text-3xl font-black bg-gradient-to-r from-gray-700 to-gray-900 bg-clip-text text-transparent mb-1">12,345</div>
            <div className="text-xs text-gray-700 font-bold">Total Grievances</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-black bg-gradient-to-r from-gray-700 to-gray-900 bg-clip-text text-transparent mb-1">10,890</div>
            <div className="text-xs text-gray-700 font-bold">Resolved Cases</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-black bg-gradient-to-r from-gray-700 to-gray-900 bg-clip-text text-transparent mb-1">48h</div>
            <div className="text-xs text-gray-700 font-bold">Avg Resolution Time</div>
          </div>
        </div>
        ...
        >
          <Button 
            className="bg-black hover:bg-gray-800 text-white px-8 py-5 text-base font-bold rounded-xl group transition-all duration-300 shadow-2xl hover:shadow-3xl" 
          ...
          <Button 
            variant="outline" 
            className="bg-white hover:bg-gray-50 text-black px-8 py-5 text-base font-bold rounded-xl group transition-all duration-300 border-2 border-black shadow-xl hover:shadow-2xl" 
